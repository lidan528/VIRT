...
class DocExample(object):
    def __init__(self, query_tokens, query_segment_ids,
                 doc_tokens, doc_segment_ids,
                 query_ids=None, query_masks=None,
                 doc_ids=None, doc_masks=None, label=None):
...
def create_examples_lidan528(train_data, max_query_length, max_doc_length, tokenizer):
    ...
    for ex in train_data:
        ...
        yield DocExample(query_tokens=query_tokens_p, query_segment_ids=query_segment_ids,
                         doc_tokens=positive_doc_tokens_p, doc_segment_ids=positive_doc_segment_ids,
                         query_ids=query_ids, query_masks=query_masks,
                         doc_ids=positive_doc_ids, doc_masks=positive_doc_masks, label=1
                         )
        yield DocExample(query_tokens=query_tokens_p, query_segment_ids=query_segment_ids,
                         doc_tokens=negative_doc_tokens_p, doc_segment_ids=negative_doc_segment_ids,
                         query_ids=query_ids, query_masks=query_masks,
                         doc_ids=negative_doc_ids, doc_masks=negative_doc_masks, label=0
                         )
