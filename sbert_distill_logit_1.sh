...
export TEACHER_MODEL_DIR=/home/hadoop-aipnlp/cephfs/data/lidan65/distill/output/mnli/bert_base_bipartition
...
export OUTPUT=/home/hadoop-aipnlp/cephfs/data/lidan65/distill/output/mnli/s_bert_distll_mse_0.2/
python sbert_distill.py \
  ...
  --init_checkpoint_teacher=$TEACHER_MODEL_DIR/model.ckpt-33134 \
