...
class InputFeatures(object):
  ...
  def __init__(self, input_ids_a, input_ids_b, input_mask_a, input_mask_b, segment_ids_a, segment_ids_b, label_id):
...
def convert_single_example(ex_index, example, label_list, max_seq_length,
  ...
  feature = InputFeatures(input_ids_a, input_mask_a, segment_ids_a,
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    query_embedding = \
        create_model(bert_config, is_training, input_ids_a, input_mask_a,
                     segment_ids_a, use_one_hot_embeddings)

    doc_embedding = \
        create_model(bert_config, is_training, input_ids_b, input_mask_b,
                     segment_ids_b, use_one_hot_embeddings)

    sub_embdding = tf.abs(query_embedding - doc_embedding)

    regular_embedding = tf.concat([query_embedding, doc_embedding, sub_embdding], -1)
