...
class InputFeatures(object):
    ...
    def __init__(self, input_ids_a1, input_mask_a1, segment_ids_a1,
                 ...
                 input_ids_b2, input_mask_b2, segment_ids_b2):
...
class LcqmcProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            text_a2 = tokenization.convert_to_unicode(line[2])
            text_b2 = tokenization.convert_to_unicode(line[3])
            ...
            examples.append(
                InputExample(guid=guid, text_a1=text_a1, text_b1=text_b1, text_a2=text_a2, text_b2=text_b2))
        return examples
...
def convert_single_example_pair(ex_index, example, label_list, max_seq_length_a, max_seq_length_b,
  ...
  (input_ids_a1, input_mask_a1, segment_ids_a1, input_ids_b1, input_mask_b1, segment_ids_b1) = convert_single_example(ex_index, example, example.text_a1, example.text_b1, label_list, max_seq_length_a, max_seq_length_b, tokenizer)
  (input_ids_a2, input_mask_a2, segment_ids_a2, input_ids_b2, input_mask_b2, segment_ids_b2) = convert_single_example(ex_index, example, example.text_a2, example.text_b2, label_list, max_seq_length_a, max_seq_length_b, tokenizer)
...
def model_fn_builder(bert_config, num_rele_label, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN or mode == tf.estimator.ModeKeys.EVAL:
            ...
            query_embedding1 = create_model(bert_config, FLAGS.max_seq_length_a, is_training, input_ids_a1, input_mask_a1, segment_ids_a1, use_one_hot_embeddings)
            doc_embedding1 = create_model(bert_config, FLAGS.max_seq_length_b, is_training, input_ids_b1, input_mask_b1, segment_ids_b1, use_one_hot_embeddings)
            ...
            # label_ids = features["label_ids"]
            query_embedding2 = create_model(bert_config, FLAGS.max_seq_length_a, is_training, input_ids_a2, input_mask_a2,
            ...
            query_embedding = create_model(bert_config, FLAGS.max_seq_length_a, is_training, input_ids_a, input_mask_a, segment_ids_a, use_one_hot_embeddings)
            doc_embedding = create_model(bert_config, FLAGS.max_seq_length_b, is_training, input_ids_a, input_mask_a, segment_ids_a, use_one_hot_embeddings)
            label_ids = 0
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        if tf.gfile.Exists(train_file):
            ...
            file_based_convert_examples_to_features(
                train_examples, label_list, FLAGS.max_seq_length_a, FLAGS.max_seq_length_b, tokenizer, train_file, is_training=True)
    ...
    if FLAGS.do_predict:
        ...
        if not tf.gfile.Exists(predict_file):
            file_based_convert_examples_to_features(predict_examples, label_list, FLAGS.max_seq_length_a, FLAGS.max_seq_length_b, tokenizer, predict_file)
        else:
    ...
    if FLAGS.do_save:
        ...
        estimator.export_savedmodel(FLAGS.output_dir, serving_input_receiver_fn=serving_input_receiver_fn(FLAGS.max_seq_length_a))
